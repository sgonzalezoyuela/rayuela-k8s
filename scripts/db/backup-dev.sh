#!/usr/bin/env bash
# =============================================================================
# backup-dev.sh - Create a local backup of the production database
# =============================================================================
# Dumps the 'rayuela' database (all schemas: public + tenant_*) from the
# production pod and copies it locally to backups/.
#
# Filename format: dev-v<VERSION>-<YYYY-MM-DD>.pgdump
# Version is read from env/dev/patches/configmap.yaml (RAYUELA_VERSION).
#
# Usage:
...
CONFIGMAP="${PROJECT_ROOT}/env/dev/patches/configmap.yaml"
...
FILENAME="dev-v${VERSION}-${DATE}.pgdump"
