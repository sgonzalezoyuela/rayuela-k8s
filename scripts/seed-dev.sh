...
kubectl exec -it rayuela-db-0 -n rayuela-dev -- psql -U grex -d grext1 -f /sql/convenios-data.sql
...
kubectl exec -it rayuela-db-0 -n rayuela-dev -- psql -U grex -d grext1 -f /sql/concepto-versiones-data.sql
...
kubectl exec -it rayuela-db-0 -n rayuela-dev -- psql -U grex -d grext2 -f /sql/convenios-data.sql
...
kubectl exec -it rayuela-db-0 -n rayuela-dev -- psql -U grex -d grext2 -f /sql/concepto-versiones-data.sql
